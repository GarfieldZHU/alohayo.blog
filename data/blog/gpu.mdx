...
draft: false
summary: As we discussed in the article of [Nvidia](https://alohayo.me/blog/nvidia), GPU is really the fundamental of the new age of AI. Let's talk about what is GPU and how it works in the modern computer world.
---
...
Let's understand the GPU with the real hardware. 
