...
_Posted in my personal space because nobody asked me to. I'm just excited and slightly anxious._

---

## The thing I didn't know I was missing

A few months back I started using Claude Code and OpenCode heavily. Model goes brr, code writes itself, life is good.

Then I hit a wall. The agent would understand _exactly_ what needed to change — I could tell from its explanations — and then fail to apply the edit. Again. And again. "String to replace not found." Wrong indentation. Phantom whitespace. I started wondering if I was doing something wrong.

I wasn't. The **model** wasn't the problem. The **harness** was.

This concept clicked for me when I read [Can Bölük's benchmark research](https://blog.can.ac/2026/02/12/the-harness-problem/). He changed _nothing_ about the model — same weights, same prompt, same task. He just changed the **edit format**. Grok Code Fast 1 went from **6.7% → 68.3%** success rate. That's not a rounding error. That's a different product.
...
And most of us don't think about the bridge at all.
...
_References:_
_- [Can Bölük: The Harness Problem](https://blog.can.ac/2026/02/12/the-harness-problem/)_
_- [oh-my-openagent GitHub](https://github.com/can1357/oh-my-pi)_
